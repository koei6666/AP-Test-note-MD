...
>原則として、ブラウザがRedirectするときではPOSTを使わない、ブラウザが3xx Redirect responseを受信した後、307 Temporary Redirectと308 Permanent Redirect以外の場合は新しいGET Requestを発行し、Redirect指示を出す。
